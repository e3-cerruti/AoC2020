...
#define HEXNORTHEAST 5
    ...
    //Constants
    public final static boolean orFLAT= false;
    ...
    private static Font theFont = new Font("Courier", Font.PLAIN, 12);
...
//I think that this XYvertex stuff is taken care of in the int x line above. Why is it here twice?
    ...
    public static void drawHex(int i, int j, Graphics2D g2) {
        ...
        g2.setColor(Day24.COLOURCELL);
        //g2.fillPolygon(hexmech.hex(x,y));
        g2.fillPolygon(poly);
        g2.setColor(Day24.COLOURGRID);
        g2.drawPolygon(poly);
    }
